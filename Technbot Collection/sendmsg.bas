...
Public Sub SendMessag(thetext As String)
Dim imwindowclass As Long, richedita As Long
imwindowclass = FindWindow("imwindowclass", vbNullString)
richedita = FindWindowEx(imwindowclass, 0&, "richedit20w", vbNullString)
richedita = FindWindowEx(imwindowclass, richedita, "richedit20w", vbNullString)
